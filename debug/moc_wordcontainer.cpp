...
QT_MOC_LITERAL(1, 14, 16), // "updateWordSignal"
QT_MOC_LITERAL(2, 31, 0), // ""
QT_MOC_LITERAL(3, 32, 6), // "readin"
QT_MOC_LITERAL(4, 39, 9), // "_fileName"
QT_MOC_LITERAL(5, 49, 11), // "recvMessage"
QT_MOC_LITERAL(6, 61, 13) // "QVector<Word>"

    },
    "wordContainer\0updateWordSignal\0\0readin\0"
    "_fileName\0recvMessage\0QVector<Word>"
};
...
void wordContainer::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->updateWordSignal(); break;
        case 1: _t->readin((*reinterpret_cast< QString(*)>(_a[1]))); break;
        case 2: _t->readin(); break;
        case 3: _t->recvMessage((*reinterpret_cast< QVector<Word>(*)>(_a[1]))); break;
        default: ;
        }
        ...
        {
            typedef void (wordContainer::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&wordContainer::updateWordSignal)) {
                *result = 0;
            }
        }
    }
...
// SIGNAL 0
void wordContainer::updateWordSignal()
{
